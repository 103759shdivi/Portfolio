  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center">
      <div className="w-full max-w-4xl mx-auto px-4 py-24 text-center">
        ...
        <motion.p initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.08 }} className="text-xl text-purple-300 mt-3">{portfolioData.personalDetails.title}</motion.p>
        <motion.p initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.12 }} className="text-slate-400 mt-6 max-w-2xl mx-auto">{portfolioData.personalDetails.bio}</motion.p>
